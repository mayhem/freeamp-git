...
!MESSAGE 
!MESSAGE NMAKE /f "vorbismdf.mak" CFG="vorbismdf - Win32 Release"
!MESSAGE 
...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "..\..\\" /I "..\..\..\include" /I "..\..\include" /I "..\..\..\..\io\include" /I "..\..\..\..\base\include" /I "..\..\..\..\base\win32\include" /I "..\..\..\..\config" /I "..\..\..\..\ui\include" /I "..\..\..\..\lib\vorbis" /D "NDEBUG" /D "_WINDOWS" /D "WIN32" /D "NOMINMAX" /YX /FD /c
...
# ADD LINK32 fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x10500000" /subsystem:windows /dll /machine:I386 /out:"vorbismdf.mdf" /libpath:"..\..\..\..\base\win32" /libpath:"..\..\..\..\lmc\vorbis\win32"
...
# ADD LINK32 fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x10500000" /subsystem:windows /dll /debug /machine:I386 /out:"vorbismdf.mdf" /pdbtype:sept /libpath:"..\..\..\..\base\win32" /libpath:"..\..\..\..\lmc\vorbis\win32"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=IF NOT EXIST ..\..\..\..\base\win32\prj\plugins mkdir                               ..\..\..\..\base\win32\prj\plugins	copy vorbismdf.mdf      ..\..\..\..\base\win32\prj\plugins
# End Special Build Tool
...
# ADD LINK32 fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib shell32.lib ole32.lib wsock32.lib /nologo /base:"0x10500000" /subsystem:windows /dll /machine:I386 /out:"vorbismdf.mdf" /libpath:"..\..\..\..\base\win32" /libpath:"..\..\..\..\lmc\vorbis\win32"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=IF NOT EXIST ..\..\..\..\base\win32\prj\plugins mkdir                               ..\..\..\..\base\win32\prj\plugins	copy vorbismdf.mdf      ..\..\..\..\base\win32\prj\plugins
# End Special Build Tool
